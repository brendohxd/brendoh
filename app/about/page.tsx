          ...
          <div className="pet-showcase">
            <div className="pet-showcase__stage">
              <div
                className="pet-still"
                role="img"
                aria-label="Syntropic Seeker of Truth Codex pet"
              />
            </div>
            <div className="pet-showcase__details">
              ...
              <div className="pet-showcase__links">
                <a className="pet-showcase__download" href="/downloads/syntropic-seeker-of-truth.zip" download="syntropic-seeker-of-truth.zip">
                  Download Codex package <ArrowUpRight />
                </a>
                <a href="/pet-assets/syntropic-seeker-of-truth/syntropic-seeker-of-truth.png" download="syntropic-seeker-of-truth.png">Download still</a>
              </div>
            </div>
          </div>
        </div>
